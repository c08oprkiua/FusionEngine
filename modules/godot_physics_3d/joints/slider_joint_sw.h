...
public:
	// constructors
    SliderJointSW(BodySW* rbA, BodySW* rbB, const Transform3D& frameInA, const Transform3D& frameInB);
    //SliderJointSW();
	// overrides
	...
	void set_param(PhysicsServer3D::SliderJointParam p_param, float p_value);
	float get_param(PhysicsServer3D::SliderJointParam p_param) const;
