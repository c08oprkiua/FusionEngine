...
void SliderJointSW::set_param(PhysicsServer3D::SliderJointParam p_param, float p_value) {
...
float SliderJointSW::get_param(PhysicsServer3D::SliderJointParam p_param) const {
