...
HingeJointSW::HingeJointSW(BodySW* rbA,BodySW* rbB, const Transform3D& frameA, const Transform3D& frameB) :  JointSW(_arr,2) {
...
void HingeJointSW::set_param(PhysicsServer3D::HingeJointParam p_param, float p_value) {
...
float HingeJointSW::get_param(PhysicsServer3D::HingeJointParam p_param) const{
...
void HingeJointSW::set_flag(PhysicsServer3D::HingeJointFlag p_flag, bool p_value){
...
bool HingeJointSW::get_flag(PhysicsServer3D::HingeJointFlag p_flag) const{
