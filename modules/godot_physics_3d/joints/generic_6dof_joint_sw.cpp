...
void Generic6DOFJointSW::set_param(Vector3::Axis p_axis,PhysicsServer3D::G6DOFJointAxisParam p_param, float p_value) {
...
float Generic6DOFJointSW::get_param(Vector3::Axis p_axis,PhysicsServer3D::G6DOFJointAxisParam p_param) const{
...
void Generic6DOFJointSW::set_flag(Vector3::Axis p_axis,PhysicsServer3D::G6DOFJointAxisFlag p_flag, bool p_value){
...
bool Generic6DOFJointSW::get_flag(Vector3::Axis p_axis,PhysicsServer3D::G6DOFJointAxisFlag p_flag) const{
