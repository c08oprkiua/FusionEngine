...
public:
	...
	void set_param(PhysicsServer3D::HingeJointParam p_param, float p_value);
	float get_param(PhysicsServer3D::HingeJointParam p_param) const;
	...
	HingeJointSW(BodySW* rbA,BodySW* rbB, const Transform3D& frameA, const Transform3D& frameB);
