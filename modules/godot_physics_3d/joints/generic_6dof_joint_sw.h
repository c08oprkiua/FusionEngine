...
public:
    ...
    */
    ...
    void set_param(Vector3::Axis p_axis,PhysicsServer3D::G6DOFJointAxisParam p_param, float p_value);
    float get_param(Vector3::Axis p_axis,PhysicsServer3D::G6DOFJointAxisParam p_param) const;
